...
root = here.parent
cache_path = root.joinpath(".piss_cache", "manage_clvm.json")
...
from piss.types.blockchain_format.serialized_program import SerializedProgram  # noqa: E402
...
top_levels = {"piss"}
hashes_path = root.joinpath("piss/wallet/puzzles/deployed_puzzle_hashes.json")
std_libraries = root.joinpath("piss/wallet/puzzles")
...
main(auto_envvar_prefix="piss_MANAGE_CLVM")
