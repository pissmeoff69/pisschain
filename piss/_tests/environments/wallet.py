...
from piss.cmds.cmd_helpers import NeedsTXConfig, NeedsWalletRPC, TransactionEndpoint, TransactionsOut, WalletClientInfo
from piss.cmds.param_types import CliAmount, cli_amount_none
from piss.rpc.full_node_rpc_client import FullNodeRpcClient
from piss.rpc.rpc_server import RpcServer
from piss.rpc.wallet_rpc_api import WalletRpcApi
from piss.rpc.wallet_rpc_client import WalletRpcClient
...
from piss.wallet.transaction_record import LightTransactionRecord
from piss.wallet.util.transaction_type import CLAWBACK_INCOMING_TRANSACTION_TYPES
from piss.wallet.util.tx_config import DEFAULT_TX_CONFIG, TXConfig
from piss.wallet.wallet import Wallet
from piss.wallet.wallet_node import Balance, WalletNode
from piss.wallet.wallet_node_api import WalletNodeAPI
...
class WalletTestFramework:
    ...
    def new_puzzle_hashes_allowed() -> Iterator[None]:
        with unittest.mock.patch(
            "piss.wallet.wallet_state_manager.WalletStateManager.new_action_scope",
