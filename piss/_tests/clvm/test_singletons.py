...
import pytest
from piss_rs import AugSchemeMPL, CoinSpend, G1Element, G2Element, PrivateKey, SpendBundle
from piss_rs.sized_bytes import bytes32
from piss_rs.sized_ints import uint64

from piss._tests.clvm.test_puzzles import public_key_for_index, secret_exponent_for_index
from piss._tests.util.key_tool import KeyTool
from piss._tests.util.spend_sim import CostLogger, SimClient, SpendSim, sim_and_client
...
from piss.wallet.lineage_proof import LineageProof
from piss.wallet.puzzles import p2_conditions, p2_delegated_puzzle_or_hidden_puzzle

"""
This test suite aims to test:
    - piss.wallet.puzzles.singleton_top_layer.py
    - piss.wallet.puzzles.singleton_top_layer.clsp
    - piss.wallet.puzzles.singleton_top_layer_v1_1.py
    - piss.wallet.puzzles.singleton_top_layer_v1_1.clsp
    - piss.wallet.puzzles.p2_singleton.clsp
    - piss.wallet.puzzles.p2_singleton_or_delayed_puzhash.clsp
"""
...
async def test_singleton_top_layer(version, cost_logger):
    async with sim_and_client() as (sim, sim_client):
        ...
        if version == 0:
            from piss.wallet.puzzles import singleton_top_layer

            adapted_puzzle: Program = singleton_top_layer.adapt_inner_to_singleton(starting_puzzle)
        else:
            from piss.wallet.puzzles import singleton_top_layer_v1_1 as singleton_top_layer
