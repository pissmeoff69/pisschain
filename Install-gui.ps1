...
Push-Location
try {
    Set-Location piss-blockchain-gui
    ...
    Write-Output ""
    Write-Output "piss blockchain Install-gui.ps1 completed."
    Write-Output ""
    Write-Output "Type 'cd piss-blockchain-gui' and then 'npm run electron' to start the GUI."
} finally {
    Pop-Location
}
