...
{
    Write-Output "piss requires a 64-bit Windows installation"
    Exit 1
}
...
Write-Output ""
Write-Output "piss blockchain .\Install.ps1 complete."
Write-Output "For assistance join us on Discord in the #support chat channel:"
Write-Output "https://discord.gg/piss"
Write-Output ""
Write-Output "Try the Quick Start Guide to running piss-blockchain:"
Write-Output "https://docs.piss.net/introduction"
Write-Output ""
Write-Output "To install the GUI run '.\.venv\scripts\Activate.ps1' then '.\Install-gui.ps1'."
Write-Output ""
Write-Output "Type '.\.venv\Scripts\Activate.ps1' and then 'piss init' to begin."
